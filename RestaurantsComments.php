...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    mysqli_query($con, "INSERT INTO comment_restaurants (name, comment) VALUES ('$name','$comment')"); //Inserts the value to table users
...
<!--display -->
           ...
           <?php
               ...
               $c = mysqli_query($conn, "Select * from comment_restaurants");
              ...
              $query = mysqli_query($conn, "SELECT * FROM comment_restaurants"); // SQL Query
